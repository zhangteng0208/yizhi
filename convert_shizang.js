...
// 源目录和目标目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/诗藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/shizang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 shizang 前缀
    bookList.push({
      id: `shizang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '诗词',
      categoryEn: 'shici',
