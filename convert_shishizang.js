...
// 源目录和目标目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/史藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/shishizang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 shishizang 前缀
    bookList.push({
      id: `shishizang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '史书',
      categoryEn: 'shishu',
