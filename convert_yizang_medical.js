...
// 源目录和目标目录 - 医藏使用 yizang 目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/医藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/yizang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 yizang 前缀（医藏的拼音）
    bookList.push({
      id: `yizang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '医学',
      categoryEn: 'yixue',
...
console.log(`\n⚠️  注意：医藏书籍使用 yizang 目录和前缀，与易藏（yizang）区分开`);
