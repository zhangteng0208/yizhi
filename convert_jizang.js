...
// 源目录和目标目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/集藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/jizang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 jizang 前缀
    bookList.push({
      id: `jizang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '文集',
      categoryEn: 'wenji',
