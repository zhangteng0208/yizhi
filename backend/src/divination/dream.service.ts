...
// 梦兆词典：关键词 → 解释列表
const DREAM_DICTIONARY: Record<string, { meaning: string; category: string; isGood: boolean }[]> = {
  // 动物类
  '蛇': [
    { meaning: '代表生财，财源广进', category: '财运', isGood: true },
    { meaning: '象征智慧与直觉', category: '事业', isGood: true },
    { meaning: '若被蛇追，预示近期有小人作祟', category: '人际', isGood: false },
  ...
  '医生': [
    { meaning: '医者到来，病灾将愈', category: '健康', isGood: true },
  ],
  '菩萨': [
  ...
  '雷': [
    { meaning: '雷声大作，贵人将至', category: '人际', isGood: true },
  ],
  '太阳': [
  ...
  '窗户': [
    { meaning: '窗户明亮，前途光明', category: '事业', isGood: true },
  ],
  '楼梯': [
  ...
  '手机': [
    { meaning: '手机来讯，消息将至', category: '人际', isGood: true },
  ],
  '电脑': [
    { meaning: '电脑升级，事业发展', category: '事业', isGood: true },
  ],
  '棺材': [
  ...
  '头': [
    { meaning: '头脑清醒，智慧增长', category: '事业', isGood: true },
  ],
  '手': [
  ...
  '眼睛': [
    { meaning: '眼明心亮，看清局势', category: '事业', isGood: true },
  ],
  ...
  '肉': [
    { meaning: '吃肉有力，身体健康', category: '健康', isGood: true },
  ],
  '水果': [
    { meaning: '水果丰硕，财运旺盛', category: '财运', isGood: true },
  ],
  ...
  '游泳': [
    { meaning: '游泳顺利，财运亨通', category: '财运', isGood: true },
  ],
  '跑步': [
    { meaning: '跑步前进，事业发展', category: '事业', isGood: true },
  ],
  '考试': [
  ...
  '旅行': [
    { meaning: '旅行远行，机遇来临', category: '事业', isGood: true },
  ],
  '搬家': [
    { meaning: '乔迁之喜，财运将至', category: '财运', isGood: true },
  ],
  '工作': [
    { meaning: '工作顺利，职位晋升', category: '事业', isGood: true },
  ],
  '理发': [
    { meaning: '理发整洁，形象提升', category: '事业', isGood: true },
  ],
  '洗澡': [
    { meaning: '洗澡除晦，运势反转', category: '事业', isGood: true },
  ],
  '睡觉': [
    { meaning: '安眠无梦，修养身心', category: '健康', isGood: true },
  ],
  '唱歌': [
    { meaning: '歌声嘹亮，喜事临门', category: '事业', isGood: true },
  ],
  '跳舞': [
    { meaning: '舞步轻盈，财运亨通', category: '财运', isGood: true },
  ],
  '购物': [
    { meaning: '买到便宜，省钱有道', category: '财运', isGood: true },
  ],
  '逃跑': [
    { meaning: '逃跑成功，躲避灾祸', category: '安全', isGood: true },
  ],
  '哭泣': [
    { meaning: '哭泣释放，压力解除', category: '健康', isGood: true },
  ],
  '笑': [
    { meaning: '笑声不断，喜事连连', category: '事业', isGood: true },
  ],
  '做饭': [
    { meaning: '做饭持家，生活安稳', category: '家庭', isGood: true },
  ],
  '钓鱼': [
    { meaning: '钓鱼收获，财运到来', category: '财运', isGood: true },
  ],
  '开车': [
    { meaning: '开车顺风，财运亨通', category: '财运', isGood: true },
  ],
  '坐飞机': [
    { meaning: '飞机起飞，职位晋升', category: '事业', isGood: true },
  ],
  '坐船': [
    { meaning: '船行水中，财运平稳', category: '财运', isGood: true },
  ],
  '爬山': [
    { meaning: '爬山登顶，志在千里', category: '事业', isGood: true },
  ],
  '打电话': [
    { meaning: '电话畅通，消息将至', category: '人际', isGood: true },
  ],
  
  // 颜色类
  '红色': [
    { meaning: '红红火火，财运旺盛', category: '财运', isGood: true },
  ],
  '白色': [
    { meaning: '白色纯洁，平安吉祥', category: '健康', isGood: true },
  ],
  '黑色': [
    { meaning: '黑色神秘，智慧增长', category: '事业', isGood: true },
  ],
  '金色': [
    { meaning: '金色辉煌，财运亨通', category: '财运', isGood: true },
  ],
  '绿色': [
    { meaning: '绿草如茵，生机盎然', category: '健康', isGood: true },
  ],
  '蓝色': [
    { meaning: '蓝天白云，前程似锦', category: '事业', isGood: true },
  ],
  
  // 其他
  '厕所': [
    { meaning: '厕所干净，晦气消除', category: '事业', isGood: true },
  ],
  '监狱': [
    { meaning: '监狱释放，困境解除', category: '事业', isGood: true },
  ],
  '学校': [
    { meaning: '学校学习，技能提升', category: '事业', isGood: true },
  ],
  '医院': [
    { meaning: '医院康复，身体健康', category: '健康', isGood: true },
  ],
  '银行': [
    { meaning: '银行存钱，积蓄增加', category: '财运', isGood: true },
  ],
};
...
export class DreamService {
  ...
  calculate(dream: string): DreamResult {
    ...
    if (interpretations.length === 0) {
      return {
        ...
        overall: {
          isGood: true,
          summary: '此梦境较为独特，需结合更多细节分析。梦境往往反映潜意识的期待与担忧，建议回顾近期生活状态，审视梦境中的情感色彩。',
        },
      };
    }
    ...
    if (isGood) {
      ...
      if (badCount >= 3) {
        ...
        summary = '梦境略有波折但不必过于担忧。保持积极心态，谨慎应对即可化解。';
      }
    }
  ...
  private extractKeywords(dream: string): string[] {
    ...
    // 按关键词长度降序排序，优先匹配更长的词
    const sortedKeywords = Object.keys(DREAM_DICTIONARY).sort((a, b) => b.length - a.length);
