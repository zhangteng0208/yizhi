...
// 源目录和目标目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/艺藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/yishuzang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 yishuzang 前缀
    bookList.push({
      id: `yishuzang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '艺术',
      categoryEn: 'yishu',
