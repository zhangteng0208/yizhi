...
// 源目录和目标目录
const sourceDir = '/Users/mac/projects/yizhi/daizhigev20/子藏';
const targetDir = '/Users/mac/projects/yizhi/frontend/public/data/classics/zizang';
...
function processTxtFile(filePath) {
  try {
    ...
    // 添加到书籍列表 - 使用 zizang 前缀
    bookList.push({
      id: `zizang/${jsonFileName.replace('.json', '')}`,
      name: bookTitle,
      category: '诸子',
      categoryEn: 'zhuzi',
